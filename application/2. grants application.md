...
In the link below you will find the conversation between Unite DAO Core Team members: Alex Puig, Art Kateiva and Joan de Ramon Brunet:

https://www.youtube.com/watch?v=563j_mqu1N0&t=1s
...
In the link below, you will find Unite DAO Roadmap in Detail. 

https://docs.google.com/spreadsheets/d/1Cg38Fum1Wg95BH6savCjGpaUvO9Gst4TASexf-JjisM/edit#gid=1364622344

The detailed Roadmap consists of these parts:
...
In the Phase section, we also mark with "-" when the task is expected to be done and a green box named "done" when the task is finished. 
