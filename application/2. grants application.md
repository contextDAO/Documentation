...
- A need for standards when communicating with each other. In a short period (past few months), we spoke with many projects and protocols - all agreed that we need some standard to communicate with each other. 
